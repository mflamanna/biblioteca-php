<?php
 ...
 $sql = "UPDATE worksofart SET name='$name' artist='$artist', year='$year', technique='$technique', location='$location', description='$description', img='$img' WHERE id=$id";
...
<div class="flex items-center justify-center h-auto bg-red-100">
      <div class="bg-white rounded-2xl border shadow-x1 p-10 max-w-lg m-5">
        <div class="flex flex-col items-center space-y-4">
          ...
          <form action="edit-art.php" method="post">
          <input
            type="text"
